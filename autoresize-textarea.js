...
(function(global, factory) {
  ...
  var autoResize = function(elem) {
    ...
    // 
    var vPadding = parseFloat(curCSS(elem, 'paddingTop')) + parseFloat(curCSS(elem, 'paddingBottom'));
    ...
    if (desc.addEventListener) {
      addEvent(desc, 'input', setHeight);
      if (isSelectionchangeSupport) {
        addEvent(desc, 'focus', onFocusChange);
        addEvent(desc, 'blur', onFocusChange);
      }
